var Jobie = function () {
	...
	// 		  {
	// 			  document.querySelector('#DZ_W_Contacts_Body3').innerHTML += ('<div class="d-flex justify-content-start mb-4">                            <div class="img_cont_msg">                                <img src="/static/images/avatar/1.jpg" class="rounded-circle user_img_msg" alt="">                            </div>                            <div class="msg_cotainer">                              '+data.message+'                  <span class="msg_time">9:12 ��</span>                            </div>                        </div>');			  }
	// 		  else{
	// 			  document.querySelector('#DZ_W_Contacts_Body3').innerHTML += ('<div class="d-flex justify-content-end mb-4">                            <div class="msg_cotainer_send">                                '+data.message+' <span class="msg_time_send">9:05 ��</span>                            </div>                            <div class="img_cont_msg">                                <img src="/static/images/avatar/2.jpg" class="rounded-circle user_img_msg" alt="">                            </div>                        </div>');
	// 			  }
