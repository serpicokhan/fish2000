...
urlpatterns = [
    ...
    url(r'^personel/brief/All$', list_personel_breif_all, name='list_personel_breif_all'),
    url(r'^personel/brief/getInfo$', get_personel_breig_info, name='get_personel_breig_info'),
    url(r'^personel/brief/getInfo/All$', get_personel_breig_info_all, name='get_personel_breig_info_all'),
